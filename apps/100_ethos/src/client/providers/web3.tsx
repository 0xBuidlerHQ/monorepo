...
const useWeb3Primitive = () => {
	 ...
	 *
	 */
	const { mutate: connectPrimitive } = Hooks.useConnect();
		...
		connectPrimitive(
			{
				...
				signInWithEthereum: {
					authUrl: {
						nonce: "http://localhost:8000/user/siwe/nonce",
						verify: "http://localhost:8000/user/siwe/verify",
						logout: "http://localhost:8000/user/siwe/logout",
					},
				},
			},
			{
