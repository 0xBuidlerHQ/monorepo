...
const OptimismLogo = (props: SVGProps<SVGSVGElement>) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" xmlSpace="preserve" {...props}>
		<title>Optimism Logo</title>
